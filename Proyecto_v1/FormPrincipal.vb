...
#Region "Apertura de formularios"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnPacinte.Click
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles btnTurnos.Click
        AbrirFormEnPanel(Of TablaTurnos)()
        btnTurnos.BackColor = Color.SpringGreen
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles btnAgenda.Click
        AbrirFormEnPanel(Of CalendarForm)()
    ...
    Private Sub CerrarFormulario(ByVal sender As Object, ByVal e As FormClosedEventArgs)
        ...
        If (Application.OpenForms("Form1") Is Nothing) Then
            btnPacinte.BackColor = Color.SkyBlue
        End If
    ...
    Private Sub PanelFormulario_Paint(sender As Object, e As PaintEventArgs) Handles PanelFormulario.Paint
    ...
    Private Sub tmMostrarMenu_Tick(sender As Object, e As EventArgs) Handles tmMostrarMenu.Tick
        ...
        End If
    End Sub
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles btnMenu.Click
        If PanelMenu.Width = 220 Then
